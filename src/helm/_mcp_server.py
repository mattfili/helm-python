...
from helm._permissions import PermissionDeniedError
...
async def _handle_message(helm: Helm, message: dict[str, Any]) -> dict[str, Any] | None:
    ...
    if method == "initialize":
        return {
            ...
            "result": {
                ...
                "capabilities": {"tools": {}},
                "serverInfo": {"name": "helm-mcp", "version": "0.1.0"},
            },
        }
    ...
    if method == "tools/call":
        ...
        try:
            if tool_name == "search":
                ...
                result = await helm.call(op_name, args or None)
...
async def serve(helm: Helm) -> None:
    ...
    for line_str in sys.stdin:
        ...
        response = await _handle_message(helm, message)
