...
The core differentiator. Code Mode uses `agent.call()` to chain operations with branching, looping, and variable assignment over typed results — turning fairlead into a programmable agent runtime.
