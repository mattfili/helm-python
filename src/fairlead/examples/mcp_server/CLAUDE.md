...
Exposing fairlead as an MCP server with selected skills and permissions, ready for Claude Desktop integration.
...
## Key Imports
```python
from fairlead import Fairlead, FairleadOptions, serve, fs, git, grep, edit, http, shell
```

## How to Replicate This Pattern
1. Create a `Fairlead` instance with desired permissions
