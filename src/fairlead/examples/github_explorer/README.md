...
Combine OpenAPI skill + custom analysis skill + Code Mode into a multi-step explore-analyze-report workflow. This is fairlead's "wow" example — real API data, custom scoring, and formatted reports in one script.
