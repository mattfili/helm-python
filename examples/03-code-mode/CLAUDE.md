...
Server-side Code Mode: chaining `agent.call()` with Python control flow — the key differentiator of helm.
...
matches = await agent.call("grep.search", {"pattern": "helm", "path": "."})
