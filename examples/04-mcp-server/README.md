...
Expose helm as an MCP (Model Context Protocol) server. Claude Desktop and other MCP clients get a 2-tool interface: `search` to discover operations and `call` to invoke them.

## What You'll Learn

- Configuring helm skills for MCP exposure
