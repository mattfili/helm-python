"""MCP client — manages a helm MCP server subprocess and JSON-RPC communication."""
...
class MCPClient:
    """Spawns a helm MCP server and communicates via JSON-RPC over stdio."""
    ...
    async def start(self) -> None:
        ...
        server_path = str(Path(__file__).parent.parent / "04-mcp-server" / "server.py")
        ...
        await self._send("initialize", {
            ...
            "capabilities": {},
            "clientInfo": {"name": "helm-chat", "version": "0.1.0"},
        })
